...
public class DemoApplication {
	...
	CommandLineRunner comanndLineRunner(KorisnikRepository repository, JezikServiceJPA jezikServiceJPA, PasswordEncoder passwordEncoder, UciteljRepository uciteljRepository){
		return args -> {
			...
			uciteljRepository.save(new Ucitelj("Ivica", "Maric","ivica.maric@gmail.com", passwordEncoder.encode("pass123"),"Učitelj", Role.ROLE_USER));
			uciteljRepository.save(new Ucitelj("Perica",  "Peric","perica.peric@gmail.com", passwordEncoder.encode("nogomet123"),"Učitelj", Role.ROLE_USER));
